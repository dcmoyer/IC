...
noise.noise_the_data('ba_50',cascade_directory,number_of_cascades, 0.1)
#exit()
...
start = time.time()
second_try.NetInf(k, graph_name, number_of_cascades, cascade_directory, 0.5,beta=beta,num_threads=6,verbose=True)
stop = time.time()
